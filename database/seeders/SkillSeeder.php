    ...
    public function run(): void
    {
        $skills = [
            'Berserker' => [
                ...
                ['name' => 'Amukan Iblis', 'stat' => 'physical', 'stamina' => 65, 'mana' => 0, 'cd' => 30, 'mult' => 2.7, 'tier' => 3,
                    'desc' => 'Ultimate: rentetan pukulan liar tanpa henti, damage fisik masif.', 'icon' => 'berserker-amukan-iblis.svg'],
                ['name' => 'Murka Tanpa Ampun', 'stat' => 'magic', 'stamina' => 30, 'mana' => 40, 'cd' => 30, 'mult' => 2.4, 'tier' => 3,
            ...
            'Spellblade' => [
                ...
                ['name' => 'Bilah Dimensi', 'stat' => 'physical', 'stamina' => 40, 'mana' => 20, 'cd' => 30, 'mult' => 2.6, 'tier' => 3,
                    'desc' => 'Ultimate: bilah pedang merobek ruang, damage fisik besar ke satu target.', 'icon' => 'spellblade-bilah-dimensi.svg'],
                ['name' => 'Singularitas Arkana', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.7, 'tier' => 3,
            ...
            'Paladin' => [
                ...
                ['name' => 'Sumpah Ksatria', 'stat' => 'physical', 'stamina' => 45, 'mana' => 15, 'cd' => 30, 'mult' => 2.5, 'tier' => 3,
                    'desc' => 'Ultimate: menghantam musuh dengan seluruh kekuatan fisik dan berkat.', 'icon' => 'paladin-sumpah-ksatria.svg'],
                ['name' => 'Hukuman Surga', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.8, 'tier' => 3,
            ...
            'Bulwark' => [
                ...
                ['name' => 'Benteng Tak Tergoyahkan', 'stat' => 'physical', 'stamina' => 60, 'mana' => 0, 'cd' => 30, 'mult' => 2.2, 'tier' => 3,
                ...
                ['name' => 'Murka Penjaga', 'stat' => 'magic', 'stamina' => 0, 'mana' => 55, 'cd' => 30, 'mult' => 2.3, 'tier' => 3,
            ...
            'Warden' => [
                ...
                ['name' => 'Benteng Mana', 'stat' => 'physical', 'stamina' => 40, 'mana' => 25, 'cd' => 30, 'mult' => 2.2, 'tier' => 3,
                    'desc' => 'Ultimate: menyerap energi sihir musuh menjadi pertahanan masif.', 'icon' => 'warden-benteng-mana.svg'],
                ['name' => 'Runtuhan Runa', 'stat' => 'magic', 'stamina' => 0, 'mana' => 60, 'cd' => 30, 'mult' => 2.4, 'tier' => 3,
            ...
            'Sentinel' => [
                ...
                ['name' => 'Keseimbangan Sempurna', 'stat' => 'physical', 'stamina' => 35, 'mana' => 25, 'cd' => 30, 'mult' => 2.3, 'tier' => 3,
                    'desc' => 'Ultimate: menyatukan kekuatan fisik dan sihir dalam satu hantaman.', 'icon' => 'sentinel-keseimbangan-sempurna.svg'],
                ['name' => 'Harmoni Elemen', 'stat' => 'magic', 'stamina' => 20, 'mana' => 45, 'cd' => 30, 'mult' => 2.3, 'tier' => 3,
            ...
            'Pyromancer' => [
                ...
                ['name' => 'Nova Api', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.8, 'tier' => 3,
                    'desc' => 'Ultimate: ledakan api dahsyat ke seluruh area sekitar.', 'icon' => 'pyromancer-nova-api.svg'],
                ['name' => 'Titik Didih', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.9, 'tier' => 3,
            ...
            'Hydromancer' => [
                ...
                ['name' => 'Badai Tsunami', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.8, 'tier' => 3,
                    'desc' => 'Ultimate: gelombang tsunami raksasa menyapu area luas.', 'icon' => 'hydromancer-badai-tsunami.svg'],
                ['name' => 'Tekanan Laut Dalam', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.9, 'tier' => 3,
            ...
            'Geomancer' => [
                ...
                ['name' => 'Gempa Bumi', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.8, 'tier' => 3,
                    'desc' => 'Ultimate: guncangan besar meluluhlantakkan area sekitar.', 'icon' => 'geomancer-gempa-bumi.svg'],
                ['name' => 'Runtuhan Gunung', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.9, 'tier' => 3,
            ...
            'Aeromancer' => [
                ...
                ['name' => 'Topan Dahsyat', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.8, 'tier' => 3,
                    'desc' => 'Ultimate: topan raksasa menyapu seluruh area musuh.', 'icon' => 'aeromancer-topan-dahsyat.svg'],
                ['name' => 'Vakum Udara', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.9, 'tier' => 3,
            ...
            'Cleric' => [
                ...
                ['name' => 'Sanctuary', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.6, 'tier' => 3,
                    'desc' => 'Ultimate: memulihkan HP seluruh party dalam jumlah besar.', 'icon' => 'cleric-sanctuary.svg'],
                ['name' => 'Kebangkitan Cahaya', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.9, 'tier' => 3,
            ...
            'Warlock' => [
                ...
                ['name' => 'Wabah Kutukan', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.7, 'tier' => 3,
                    'desc' => 'Ultimate: menyebarkan kutukan berat ke seluruh musuh di area.', 'icon' => 'warlock-wabah-kutukan.svg'],
                ['name' => 'Genggaman Maut', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.9, 'tier' => 3,
            ...
            'Enchanter' => [
                ...
                ['name' => 'Simfoni Kemenangan', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.4, 'tier' => 3,
                    'desc' => 'Ultimate: seluruh tim mendapat buff damage dan kecepatan besar.', 'icon' => 'enchanter-simfoni-kemenangan.svg'],
                ['name' => 'Requiem Terakhir', 'stat' => 'magic', 'stamina' => 0, 'mana' => 65, 'cd' => 30, 'mult' => 2.6, 'tier' => 3,
